...
<p style="color:#9ca3af;font-size:11px;margin-top:24px">Si vous ne souhaitez plus recevoir ces notifications, <a href="${dashboardUrl}" style="color:#6b7280">gérez vos préférences</a>.</p>
    ...
    // Les demandes de transport depuis une fiche pro passent désormais
    // directement par POST /api/demande-transport (avec pro_id_cible), qui gère
    // dispatch départemental, distance et estimation CPAM. Cette route reste
    // dédiée à la messagerie simple pro <-> patient (sanitaire_messages).
