      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/bon-de-transport" className="hover:text-white transition">Guide bon de transport</Link></li>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-gray-500">
            ...
            <Link href="/partenaires/assurance-pro" className="hover:text-white transition">Assurances</Link>
