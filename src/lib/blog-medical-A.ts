...
export const ARTICLES: BlogPost[] = [
  // ============================================================
  // ARTICLE 2 — PILIER : Remboursement transport medical
  // ============================================================
  {
...
`,
  ...
  // ============================================================
  // ARTICLE 3 — PILIER : Droit transport medical rembourse
  // ============================================================
  {
    slug: "droit-transport-medical-rembourse",
    title: "Qui a droit au transport medical rembourse par la Securite sociale ?",
    excerpt:
    ...
    readingTime: 12,
    keywords: [
      "droit transport medical rembourse",
      "conditions remboursement ambulance",
      "transport sanitaire ayant droit",
      "transport medical securite sociale",
      "transport medical ALD",
      "qui peut beneficier transport medical",
      "remboursement transport CPAM conditions",
    ],
    content: `
